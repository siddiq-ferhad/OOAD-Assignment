...
public class Game {
    ...
    // Switch the player turn between YELLOW and BLUE, flips the game board, and checks for winning conditions
    ...
    // handle a special rule related to turns ( switching pieces : plus and time )
